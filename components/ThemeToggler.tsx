...
const ThemeToggler = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-600 dark:peer-focus:ring-gray-800 rounded-full peer dark:bg-[#3B3B3B] dark:border-gray-600 peer-checked:bg-gray-600"></div>
